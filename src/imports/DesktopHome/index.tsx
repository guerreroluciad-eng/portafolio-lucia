import svgPaths from "./svg-uri4v7r54i";
import imgFrame241 from "./33713cd496871fd3f12e9ab6f7aebfdd2fb86b3f.png";
...
function Header({ className }: { className?: string }) {
  return (
    <div className={className || "h-[91px] relative w-[1334px]"} data-name="Header">
...
export default function DesktopHome() {
  return (
    <div className="bg-[#e1dad0] relative size-full" data-name="Desktop - Home">
      <Header className="absolute h-[91px] left-[60px] top-[50px] w-[1334px]" />
