...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex items-center left-[calc(50%-0.5px)] top-[250px]">
      <p className="[word-break:break-word] font-['Abhaya_Libre:Regular',sans-serif] h-[215px] leading-[normal] not-italic relative shrink-0 text-[150px] text-white w-[511px]">Android</p>
    </div>
  );
}
    ...
    <div className="h-[338px] overflow-clip relative shrink-0 w-[322px]" data-name="CoverAndroid">
      <div className="-translate-x-1/2 absolute h-[338px] left-1/2 top-0 w-[324px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <img alt="" className="absolute max-w-none mix-blend-multiply object-cover size-full" src={imgRectangle16} />
