...
function Frame() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex items-center left-[calc(50%-0.5px)] top-[250px]">
      <p className="[word-break:break-word] font-['Abhaya_Libre:Regular',sans-serif] h-[215px] leading-[normal] not-italic relative shrink-0 text-[150px] text-white w-[750px]">App Tiempo</p>
    </div>
  );
}
    ...
    <div className="h-[337px] overflow-clip relative shrink-0 w-[234px]" data-name="CoverMaestro">
      <div className="absolute h-[338px] left-0 top-[0.5px] w-[234px]">
        <div aria-hidden className="absolute inset-0 pointer-events-none">
          <img alt="" className="absolute max-w-none mix-blend-darken object-cover size-full" src={imgRectangle21} />
...
export default function DesktopHover() {
  return (
    <div className="bg-[#e1dad0] relative size-full" data-name="Desktop - Hover 6">
      <Frame />
